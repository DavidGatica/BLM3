...
theil = document.getElementById("alcolor");
theil.style.background= "#333333";
}</script>
...
<script language="javascript" type="text/javascript">
function CambiarColor6(id, Color)
{
theid = document.getElementById(id);
theid.style.background= Color;
theim = document.getElementById("apcolor");
...
theik = document.getElementById("adccolor");
theik.style.background= "#333333";
theil = document.getElementById("akcolor");
theil.style.background= "#333333";
}</script>
...
<button style="padding:4px; background:#333333;" id="apcolor" class="boton" href="santafe.php">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
</button>
</a> 
...
<a href="javascript:;" onclick="CambiarColor6('alcolor','#FDBC00'); return false;" id="enlace6"> 
