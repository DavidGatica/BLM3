...
<div id="menu">
<a href="index.php" style="color:white">Inicio « </a> <span> ¿Quiénes somos? </span> 
</div>
...
<table border="0" align="center" width="1000px" cellpadding="20px">

<tr>

<td width="70%" valing="top">
<div id="texto1" align="justify">Por este medio queremos darles a conocer a ustedes un panorama general de la compañía Carmanah Tecnologies misma que estamos representando con el nombre de Best Light México, y que ha ganado su reputación desde hace más de 15 años en la fabricación de productos sólidos y eficaces en la iluminación. Durante este tiempo ha demostrado funcionar de manera confiable en los ambientes más inhóspitos del mundo.
<br><br>
Carmanah Tecnologies, sistemas solares autónomos con tecnología LED es una alternativa durable, eficaz y confiable a bajo costo. Nos especializamos en el desarrollo de proyectos en iluminación solar LED y soluciones de energía sustentable.</div>
<IMG  SRC="conocenos2.jpg" height="250">
</td>

<td width="30%" valing="top">
<IMG  SRC="conocenos1.jpg" height="500">
...
<td width="30%"> 
<div id="texto1" align="justify" valing="top">
Es representante exclusivo en México de carmanah,
por lo que estamos interesados en ofrecerles, además 
de la amplia gama de productos que cumplen con las
normas y exigencias de sus proyectos de iluminación
toda la asesoría y capacitación para hacer de su
proyecto todo un éxito.
<br><br>
En Best Light México, contamos con un departamento
para la elaboración de proyectos de factibilidad, 
dimensionamiento del sistema, cálculo fotométrico
y soporte técnico, para ofrecerle un mejor y confiable servicio. </div>
