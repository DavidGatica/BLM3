<?php $atras="algo" ?>
        ...
        <form action="altacliente.php" method="POST">
            ...
            <input type="text" class="inputChico" placeholder="Raz&oacute;n social" name="empresa" required><br /><br />
            <input type="text" class="inputChico" placeholder="Calle y número" name="calle_num">
            <input type="text" class="inputChico" placeholder="Municipio/Delegacion" name="municipio"><br /><br />    
            <input type="text" class="inputChico" placeholder="Estado" name="estado">
            <input type="text" class="inputChico" placeholder="C&oacute;digo Postal" name="cp"><br /><br />
            <input type="text" class="inputChico" placeholder="Nombre del contacto" name="contacto">
            <input type="text" class="inputChico" placeholder="Departamento" name="departamento"><br /><br />
            <input type="text" class="inputChico" placeholder="Tel&eacute;fono" name="telefono1">
            <input type="text" class="inputChico" placeholder="Tel&eacute;fono Alternativo" name="telefono2"><br /><br />
            <input type="text" class="inputChico" placeholder="E-mail" name="email"><br /><br /><br />
